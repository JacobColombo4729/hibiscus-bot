"""
This module contains the prompt templates used by the agents in the Hibiscus Bot.

Prompt templates are predefined recipes for generating prompts for language models.
They can contain instructions, few-shot examples, and context that is relevant to a 
specific task. This module centralizes the prompts for easier management and reuse.
"""
from langchain_core.prompts import ChatPromptTemplate

# This prompt template is designed for the SupervisorAgent.
# It provides detailed instructions on how to behave, what its capabilities and limitations are,
# and how to delegate tasks to specialized agents.
